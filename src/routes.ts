...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { FailureController } from './controllers/FailureController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
    ...
    "ProductCreationParams": {
        ...
        "properties": {
            "name": {"dataType":"string","required":true},
            "stock": {"dataType":"double","required":true},
            "price": {"dataType":"nestedObjectLiteral","nestedProperties":{"currency":{"dataType":"string","required":true},"amount":{"dataType":"double","required":true}},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/failure',
            ...(fetchMiddlewares<RequestHandler>(FailureController)),
            ...(fetchMiddlewares<RequestHandler>(FailureController.prototype.getFailure)),

            function FailureController_getFailure(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getFailure.apply(controller, validatedArgs as any);
        ...
        app.patch('/products/:id',
            ...
            function ProductController_updateProductStock(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"UpdateProductStockParams"},
                    notFoundResponse: {"in":"res","name":"404","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"reason":{"dataType":"string","required":true}}},
            };
            ...
            try {
              ...
              const promise = controller.updateProductStock.apply(controller, validatedArgs as any);
