...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    function FailureController_getFailure(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getFailure.apply(
          controller,
  ...
  app.get(
    ...
    function ProductController_getAllProducts(
      ...
      try {
        ...
        const promise = controller.getAllProducts.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function ProductController_getProductById(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.patch(
    ...
    ...fetchMiddlewares<RequestHandler>(ProductController),
    ...fetchMiddlewares<RequestHandler>(
      ProductController.prototype.updateProductStock
    ),

    function ProductController_updateProductStock(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.updateProductStock.apply(
          controller,
          validatedArgs as any
        );
  ...
  app.post(
    ...
    function ProductController_createProduct(
      request: any,
      response: any,
      next: any
    ) {
